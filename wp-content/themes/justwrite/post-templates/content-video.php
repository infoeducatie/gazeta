<?php
/* ------------------------------------------------------------------------- *
 *  The template used for displaying posts in the Video post format
/* ------------------------------------------------------------------------- */
...
<article id="post-<?php the_ID(); ?>" <?php post_class( $classes ); ?>>
	<div class="post-content">
        ...
        <header class="details clearfix">
            ...
            <a href="<?php echo esc_url( get_post_format_link( 'video' ) ); ?>" title="<?php _e( 'Video Archive', 'acosmin' ); ?>" class="post-format-icon"><?php ac_icon( 'play' ); ?></a>
        </header><!-- END .details -->
