<?php
/* ------------------------------------------------------------------------- *
 *  The template used for displaying posts in the Audio post format
/* ------------------------------------------------------------------------- */
...
<article id="post-<?php the_ID(); ?>" <?php post_class( $classes ); ?>>
	<div class="post-content">
        ...
        <header class="details clearfix">
            ...
            <a href="<?php echo esc_url( get_post_format_link( 'audio' ) ); ?>" title="<?php _e( 'Audio Archive', 'acosmin' ); ?>" class="post-format-icon"><?php ac_icon( 'volume-up' ); ?></a>
        </header><!-- END .details -->
