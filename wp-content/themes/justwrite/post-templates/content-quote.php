<?php
/* ------------------------------------------------------------------------- *
 *  The template used for displaying posts in the Quote post format
/* ------------------------------------------------------------------------- */
...
<article id="post-<?php the_ID(); ?>" <?php post_class( $classes ); ?>>
	<div class="post-content">
        ...
        <header class="details clearfix">
            ...
            <a href="<?php echo esc_url( get_post_format_link( 'quote' ) ); ?>" title="<?php _e( 'Quote Archive', 'acosmin' ); ?>" class="post-format-icon"><?php ac_icon( 'quote-left' ); ?></a>
            <?php else : endif; ?>
        </header><!-- END .details -->
