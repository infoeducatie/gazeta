...
function of_recognized_background_repeat() {
	$default = array(
		'no-repeat' => __( 'No Repeat', 'acosmin' ),
		'repeat-x'  => __( 'Repeat Horizontally', 'acosmin' ),
		'repeat-y'  => __( 'Repeat Vertically', 'acosmin' ),
		'repeat'    => __( 'Repeat All', 'acosmin' ),
		);
...
function of_recognized_background_position() {
	$default = array(
		'top left'      => __( 'Top Left', 'acosmin' ),
		'top center'    => __( 'Top Center', 'acosmin' ),
		'top right'     => __( 'Top Right', 'acosmin' ),
		'center left'   => __( 'Middle Left', 'acosmin' ),
		'center center' => __( 'Middle Center', 'acosmin' ),
		'center right'  => __( 'Middle Right', 'acosmin' ),
		'bottom left'   => __( 'Bottom Left', 'acosmin' ),
		'bottom center' => __( 'Bottom Center', 'acosmin' ),
		'bottom right'  => __( 'Bottom Right', 'acosmin')
		);
...
function of_recognized_background_attachment() {
	$default = array(
		'scroll' => __( 'Scroll Normally', 'acosmin' ),
		'fixed'  => __( 'Fixed in Place', 'acosmin')
		);
...
function of_recognized_font_styles() {
	$default = array(
		'normal'      => __( 'Normal', 'acosmin' ),
		'italic'      => __( 'Italic', 'acosmin' ),
		'bold'        => __( 'Bold', 'acosmin' ),
		'bold italic' => __( 'Bold Italic', 'acosmin' )
		);
